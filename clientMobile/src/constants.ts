...
export const STANDBY_CIRCLE_SHRINK_DURATION = 200;
export const ACTIVE_CIRCLE_PULSE_DURATION = 1500;
export const ACTIVE_CIRCLE_DEFAULT_RADIUS = 120;
export const STANDBY_CIRCLE_DEFAULT_RADIUS = 110;
